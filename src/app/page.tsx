          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Delivering innovative ICT, Data Centre, Security, Infrastructure
                and Managed Services across Africa since 2011.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-slate-700 italic font-light leading-relaxed">
                "To be the leading standard for service delivery in Africa by
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-slate-600 leading-relaxed font-light">
              "We believe technology should go beyond systems and
              infrastructure. Technology should solve real business challenges,
              improve efficiency, increase productivity and create measurable
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 max-w-6xl mx-auto">
            {[
              {
                step: "Understand",
                desc: "We identify client pain points and business requirements.",
              },
              {
                step: "Analyze",
                desc: "We carefully examine operational challenges and opportunities.",
              },
              {
                step: "Design",
                desc: "We create strategic and scalable solutions.",
              },
              {
                step: "Implement",
                desc: "We execute with precision and industry best practices.",
              },
              {
                step: "Support",
