    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <section className="pt-20 pb-16 bg-neutral-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          ...
          >
            A showcase of our successful implementations and satisfied clients across various industries.
          </motion.p>
        </div>
      </section>
            ...
            {projects.map((project, idx) => (
              ...
              >
                ...
                <div className="absolute top-6 right-6">
                  <div className={`w-14 h-14 rounded-full overflow-hidden flex items-center justify-center p-2 shadow-sm ${project.bg}`}>
                ...
                <div className="pt-4 pr-16 mb-8">
                  <p className="text-sm font-semibold text-primary-600 uppercase tracking-wider mb-2">Client</p>
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Deliverables</p>
      ...
      <section className="py-16 bg-white border-t border-slate-100 overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 mb-12 text-center">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">We have had the privilege of working with some of the most innovative and successful companies.</p>
        </div>
